...
export class ProjectNodeContentView extends React.Component {
    ...
    renderEditor() {
        ...
        return (React.createElement(InnerProseMirrorEditorView, { className: "ProjectNodeContentView__content", editorViewRef: this.editorViewRef, focusedAt: this.props.focusedAt, editorState: this.props.editorState, onStartEdit: this.onStartEdit, onEndEdit: this.onEndEdit, onDispatchTransaction: this.props.onDispatchTransaction, onApplyMark: this.props.onApplyMark, onCleanMark: this.props.onCleanMark, onRemoveStyle: this.props.onRemoveStyle, onKeyDown: this.onKeyDown, onPasteNodes: this.props.onPasteNodes, storeAnchor: this.storeAnchor }));
    }
    storeAnchor = (anchor) => {
        this.props.focusCtx.storeAnchor(this.props.node.id, anchor);
    };
    onStartEdit = () => {
