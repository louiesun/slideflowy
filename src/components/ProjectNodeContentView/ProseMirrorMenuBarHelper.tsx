...
export function renderMenuItems() {
    const i = ({ title, ...props }) => this.renderMenuItem(wrapAutoRestoreFocusMouseEvents.call(this, props, title));
    return [
        i({
        ...
        i({
            className: `underline ${this.markHelpers.underline.hasMark() ? 'active' : ''}`,
        ...
        i({ className: 'divider' }),
        this.renderMenuItem(this.wrapMenuClickEvents({
            className: 'color',
            onClick: async (e) => {
        ...
        i({
            ...
            onClick: () => {
                if (!this.markHelpers.link.hasMark())
...
function wrapAutoRestoreFocusMouseEvents(props = {}, title) {
