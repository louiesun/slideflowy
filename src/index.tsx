...
void Promise.all([
    ...
    root.render(React.createElement(RavenErrorBoundary, null, !parseQs.isSlide && store ? (React.createElement(ReduxProvider, { store: store },
        React.createElement(DiProvider, { container: container },
            React.createElement(App, null)))) : (React.createElement(Slide, null))));
});
