...
function limitedMarkdownToHtml(md) {
    ...
    function endlessReplace(re, replacer, str) {
        let result = str;
        let lastMatch;
    ...
    function replaceSubstring(start, length, replacement, processingString) {
        return [
...
export const getNoneNestedNodeList = memoizeOne((state) => {
